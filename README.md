...
* メディエーションするSDKのバージョンをアップデート

## V6.11.2 2020/09/17

* 一部メディエーション先のクラッシュを回避するためメディエーションするSDKのバージョンを調整
* デフォルトブラウザーをsafari以外に設定している場合、広告クリック後にランディングページに遷移しない問題を修正
...
* 一部メディエーションのサポート終了
* 特定の条件下で動画広告表示処理を行った際に稀にクラッシュしてしまう不具合の修正

## V6.9.2 2020/08/21

* RTBの動画リワードにおいて、特定のVASTでエンドカードが表示されない問題を修正
