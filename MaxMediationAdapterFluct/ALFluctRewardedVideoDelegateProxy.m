//
//  ALFluctRewardedVideoDelegateProxy.m
...
@interface ALFluctRewardedVideoDelegateProxy ()
@property (nonatomic) NSMutableDictionary<NSString *, id<ALFluctRewardedVideoDelegateProxyItem>> *delegateTable;
@end

@implementation ALFluctRewardedVideoDelegateProxy

+ (instancetype)sharedInstance {
    static ALFluctRewardedVideoDelegateProxy *sharedInstance;
...
- (NSString *)keyWithGroupId:(NSString *)groupId
                      unitId:(NSString *)unitId {
...
- (void)rewardedVideoShouldRewardForGroupID:(NSString *)groupId unitId:(NSString *)unitId {
    NSString *key = [self keyWithGroupId:groupId unitId:unitId];
    id<ALFluctRewardedVideoDelegateProxyItem> delegate = self.delegateTable[key];
